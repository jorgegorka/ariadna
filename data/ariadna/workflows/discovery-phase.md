...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /ariadna:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/ariadna/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/ariadna/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/ariadna/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/ariadna/templates/discovery.md
...
Use ~/.claude/ariadna/templates/discovery.md.
...
1. Discuss phase context (/ariadna:discuss-phase [current-phase])
2. Create phase plan (/ariadna:plan-phase [current-phase])
