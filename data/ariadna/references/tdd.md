...
| Ruby | Minitest | Built-in (stdlib) |
| Ruby | RSpec | `bundle add rspec --group test` |
| Ruby on Rails | Minitest | Built-in (Rails default) |
...
- RSpec: `.rspec` and `spec/spec_helper.rb` via `rspec --init`
...
- `__tests__/` directory
- `test/` directory at root (Ruby Minitest convention)
- `spec/` directory at root (RSpec convention)
