...
- This section feeds directly into /ariadna:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /ariadna:plan-phase --gaps with root causes
...
**Creation:** When /ariadna:verify-work starts new session
