...
| CSS framework | [Tailwind/Bootstrap/Bulma/custom/none] | [Gemfile, asset files] |
...
| Category | Discovered Value | Evidence |
|----------|-----------------|----------|
| Authentication | [Devise/Rails authentication generator/Rodauth/Clearance/custom/none] | [Gemfile, user model] |
...
```bash
# System dependencies
[discovered system deps: postgresql, redis, etc.]
...
[bin/jobs / bundle exec sidekiq / none]
...
**Authentication & Authorization:**
- Check for Devise initializer in `config/initializers/devise.rb`
